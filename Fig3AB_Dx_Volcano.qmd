...
all_results <- paste0('./Maaslin/',sample_type, "_maaslin_#1_allDx_v2/all_results.tsv") |> read_tsv()
...
all_results2 <- all_results2 |> 
  mutate(interst = ifelse(FeatureName == "N,N-Diethyl-P-phenylenediamine",NA,interst))
